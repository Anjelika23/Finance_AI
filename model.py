...
def _predict_ml(data: dict) -> dict:
    ...
    education    = str(data.get("education", "Not Graduate"))
    emp_status   = str(data.get("employment_status", "Employed"))
    emp_cat      = str(data.get("employer_category", "Private"))
